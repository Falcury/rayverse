...
void DO_DARK_COMMAND(obj_t* obj) {
    print_once("Not implemented: DO_DARK_COMMAND"); //stub
}
...
void DO_DARK_REACT(obj_t* obj) {
    print_once("Not implemented: DO_DARK_REACT"); //stub
}

//336C8
void DO_DARK_SORT_COMMAND(obj_t* obj) {
    print_once("Not implemented: DO_DARK_SORT_COMMAND"); //stub
}

//33980
void DO_DARK_SORT_COLLISION(obj_t* obj) {
    print_once("Not implemented: DO_DARK_SORT_COLLISION"); //stub
}

//33A18
void allocate_DARK_SORT(obj_t* obj) {
    print_once("Not implemented: allocate_DARK_SORT"); //stub
}

//33B4C
void DoAnnuleDarkSortRaymanCollision(obj_t* obj) {
    print_once("Not implemented: DoAnnuleDarkSortRaymanCollision"); //stub
}
