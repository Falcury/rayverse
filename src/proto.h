...
void DrawSpriteFlipNoClipX(i32 proj_x, i32 sprite_field_A, i32 proj_y, vec2b_t proj_size, u8* draw_buf, u8* image_data);
void DrawSpriteX(i32 proj_x, i32 sprite_field_A, i32 proj_y, vec2b_t proj_size, u8* draw_buf, u8* image_data);
void DrawSpriteNoClipX(i32 proj_x, i32 sprite_field_A, i32 proj_y, vec2b_t proj_size, u8* draw_buf, u8* image_data);
void DrawSpriteFlipX(i32 proj_x, i32 sprite_field_A, i32 proj_y, vec2b_t proj_size, u8* draw_buf, u8* image_data);
void DrawSpriteColorX(i32 proj_x, i32 sprite_field_A, i32 proj_y, vec2b_t proj_size, u8* draw_buf, u8* image_data);
void DrawSpriteColorFlipX(i32 proj_x, i32 sprite_field_A, i32 proj_y, vec2b_t proj_size, u8* draw_buf, u8* image_data);
void DrawSpriteFlipNormalNoClip(i32 proj_x, i32 sprite_field_A, i32 proj_y, vec2b_t proj_size, u8* draw_buf, u8* image_data);
void DrawSpriteNormal(i32 proj_x, i32 sprite_field_A, i32 proj_y, vec2b_t proj_size, u8* draw_buf, u8* image_data);
void DrawSpriteNormal256(i32 proj_x /*eax*/, i32 sprite_field_A /*edx*/, i32 proj_y /*ebx*/, vec2b_t proj_size /*ecx*/, u8* draw_buf /*edi*/, u8* image_data /*esi*/);
void DrawSpriteNormalNoClip(i32 proj_x, i32 sprite_field_A, i32 proj_y, vec2b_t proj_size, u8* draw_buf, u8* image_data);
void DrawSpriteFlipNormal(i32 proj_x, i32 sprite_field_A, i32 proj_y, vec2b_t proj_size, u8* draw_buf, u8* image_data);
void DrawSpriteFlipNormal256(i32 proj_x /*eax*/, i32 sprite_field_A /*edx*/, i32 proj_y /*ebx*/, vec2b_t proj_size /*ecx*/, u8* draw_buf /*edi*/, u8* image_data /*esi*/);
void DrawSpriteColorNormal(i32 proj_x, i32 sprite_field_A, i32 proj_y, vec2b_t proj_size, u8* draw_buf, u8* image_data);
void DrawSpriteColorFlipNormal(i32 proj_x, i32 sprite_field_A, i32 proj_y, vec2b_t proj_size, u8* draw_buf, u8* image_data);
void DrawSpriteDiffNormal_clip(i32 proj_x, i32 sprite_field_A, i32 proj_y, vec2b_t proj_size, u8* draw_buf, u8* image_data);
void DrawSpriteDiffNormal(i32 proj_x, i32 sprite_field_A, i32 proj_y, vec2b_t proj_size, u8* draw_buf, u8* image_data);
void synchro(void);
